...
const entries: ChangelogEntry[] = [
    ...
    },
    {
        ...
        date: "2026-01-05",
        highlights: [
            "Fix bug specimens would duplicate on a new entry.",
            "Add ability to set a specimen's sex in new entries.",
        ],
    },
    {
        version: "2.0.5",
        date: "2025-12-27",
        highlights: ["Strip image exif data when uploading images."],
    },
    {
        version: "2.0.4",
        date: "2025-12-24",
    ...
    },
    {
        version: "1.5.1",
        date: "2025-10-28",
        highlights: ["Add Image Gallery.", "Add Account Import/Export."],
    },
    {
        version: "1.5.0",
        date: "2025-10-28",
    ...
    },
    {
        version: "1.2.2",
        date: "2025-10-24",
        highlights: ["Release Candidate for final UI Design."],
    },
    {
        version: "1.2.1",
        date: "2025-10-24",
        highlights: ["Ability to delete account.", "Add ToS/Privacy Policy."],
    },
    {
        version: "1.2.0",
        date: "2025-10-23",
    ...
    },
    {
        version: "1.1.0",
        date: "2025-10-22",
        highlights: ["Add Research Notebook."],
    },
    {
        version: "1.0.3",
        date: "2025-10-22",
    ...
    },
    {
        version: "1.0.0",
        date: "2025-10-17",
        highlights: ["Initial public testing release."],
    },
];
...
const CHANGELOG = [...entries].sort((a, b) =>
...
export function getUpdatesSince(lastSeenVersion?: string | null) {
    ...
    return CHANGELOG.filter(
        (entry) => compareVersions(entry.version, lastSeenVersion) === 1,
    );
}
